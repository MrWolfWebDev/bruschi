...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="container">
            <div class="row">
                <form class="span10 offset1" enctype="multipart/form-data" action="addauto.php" method="post">
                     <div class="row"><h3>Aggiungi i dati dell'auto</h3></div>
		...
		if(isset($_POST) && !empty($_POST)){
			...
			if ($empty==0 && !empty($_FILES['files']['tmp_name'])){
				...
				$insert = "INSERT INTO `bruschi`(`Anno`, `Marca`, `Modello`, `Caratteristiche`, `Prezzo`, `Auto`) VALUES ($anno,'$marca','$modello','$descrizione',$prezzo,1)";
