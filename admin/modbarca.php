...
if ($_SESSION['auth'] == 1):
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
            <div class="container">
                <div class="row">
                    <form class="span10 offset1" method="POST" action="mod.php">
                        <div class="row"><h3>Selezione la barca da modificare</h3></div>
                        ...
                        $sql = "SELECT * FROM `bruschi` WHERE `Barca`=1";
                        ...
                        while ($auto = mysql_fetch_assoc($result)) {
                            ...
                            echo "
        <div class=\"row\">
        <input class=\"span1\" type='radio' name='auto' value='" . $auto['Id'] . "' /> <span class=\"span2\">" . $auto['Modello'] . "</span><span class=\"span1\">" . $auto['Anno'] . "</span>
        </div>";
                        }
                        ?>
                        <div class="row"><hr></hr></div>
